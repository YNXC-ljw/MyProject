...
"}"));
        horizontalLayout_3 = new QHBoxLayout(btStyle);
        horizontalLayout_3->setSpacing(0);
        horizontalLayout_3->setObjectName(QString::fromUtf8("horizontalLayout_3"));
        horizontalLayout_3->setContentsMargins(3, 0, 0, 0);
        ...
        horizontalLayout_3->addWidget(btIcon);
        ...
        horizontalLayout_3->addWidget(btText);
...
"}"));
        horizontalLayout_2 = new QHBoxLayout(lineBox);
        ...
        horizontalLayout_2->addWidget(line3);
        ...
        horizontalLayout_2->addWidget(line4);


        horizontalLayout_3->addWidget(lineBox);
